...
genleveldb.commands = touch .genleveldb; cd $$PWD/src/leveldb && { make clean; OPT=\"-std=gnu++0x -msse2\" make libleveldb.a libmemenv.a; }
...
MAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wno-unused-local-typedef -Wstack-protector
...
LIBS += -Wl,-Bdynamic -ldl -lQtGui -lQtNetwork -lQtCore -lpthread
