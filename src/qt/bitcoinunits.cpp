...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("YaCoins"));
    case mBTC: return QString(QObject::tr("Milli-YaCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-YaCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
