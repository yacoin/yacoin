  ...
  //, model(0)
{
    ...
    pQLaverage->setStyleSheet("QLabel {border: 1px solid; background-color : white; color : blue; qproperty-alignment: AlignCenter; }");
...
void ExplorerPage::on_tableViewForBlocks_activated(const QModelIndex &index)
{
