...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
     ...
     //   else
     // YACOIN TODO       settings.setValue("strThirdPartyTxUrls", "https://explorer.yacoin.org/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://explorer.yacoin.org/tx/%s").toString();
