...
void ExitTimeout(void* parg)
{
        ...
        // tests are inconclusive as to whether this helps or not?
        printf("YACoin ExitProcess()...\n");
        //ExitProcess(0);
    #else
        Sleep(5000);
        ExitProcess(0);
...
void Shutdown(void* parg)
{
    ...
    if (fFirstThread)
    {
        ...
        Sleep(50);                   // do don't seem to get here past ExitProcess() anyway?
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    printf("Using Boost MSVC full version %2d.2d build %d\n",        // VVM MPP PPP
    ...
    if (pindexBest != pindexRescan && pindexBest && pindexRescan && pindexBest->nHeight > pindexRescan->nHeight)
    {
        ...
        nStart = GetTimeMillis();
#ifdef _MSC_VER
        pwalletMain->ScanForWalletTransactions(pindexRescan, true, pindexBest->nHeight - pindexRescan->nHeight);
#else
