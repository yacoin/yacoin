...
bool CNode::Misbehaving(int howmuch)
{
    ...
    {
        int64_t banTime = GetTime()+GetArg("-bantime", fTestNet ?  nOneMinuteInSeconds : nOneDay);  // Default 24-hour ban mainnet
...
//    {"todo.yacoin.org", "todo.yacoin.org"},
	"", ""
};
...
void static StartSync(const vector<CNode*> &vNodes) {
    ...
    BOOST_FOREACH(CNode* pnode, vNodes) {
	    ...
	    (pnode->nStartingHeight > (nBestHeight - (int)nOnedayOfAverageBlocks)) &&
