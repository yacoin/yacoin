...
// what is especially bad is that if one turns the miner off and on
// the returns in the middle of this function don't free this malloc,
// ergo a memory leak
// better to do it RAII style, which would always work
